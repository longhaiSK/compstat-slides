...
## Second-Order Taylor Expansion {.smaller}
...
## From $\tilde h$ to a Gaussian {.smaller}
...
## Application 1: Marginal Likelihood and BIC {.smaller}
...
$$\theta\mid\text{data}\approx N_p\big(\theta_0, [\nabla^2h(\theta_0)]^{-1}\big), 
\int f(\theta)\,d\theta \approx f(\theta_0)(2\pi)^{p/2}|\nabla^2 h(\theta_0)|^{-1/2}$$
