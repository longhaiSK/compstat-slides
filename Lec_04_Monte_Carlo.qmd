...
## heights are proportional to 1, 2, 3.  Normalising, (1/3)(c + 2c + 3c) = 1
## gives c = 1/2, so the heights are 1/2, 1, 3/2 and the CDF passes through
## (1/3, 1/6) and (2/3, 1/2).
pw_h <- c(0.5, 1, 1.5)          # densities on the three pieces
pw_b <- c(0, 1/3, 2/3, 1)       # piece boundaries
pw_F <- cumsum(c(0, pw_h / 3))  # CDF at the boundaries: 0, 1/6, 1/2, 1
