...
KL(P\|q) &= \int P(z)\log\frac{P(z)}{q(z)}\,dz \ \ge 0
\end{aligned}
$$
...
**Remark**: $KL \ge 0$ follows from $\log x \le x - 1$:
$$KL(P\|q) = -\int P(z)\log\frac{q(z)}{P(z)}\,dz \ \ge\ -\int P(z)\Big(\frac{q(z)}{P(z)}-1\Big)\,dz = -\int\big[q(z)-P(z)\big]\,dz = 0$$
